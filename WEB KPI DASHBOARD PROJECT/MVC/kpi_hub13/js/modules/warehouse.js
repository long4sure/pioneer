...
async function whClearAll() {
    if (!await confirmDialog({title:"Clear All Data",message:"Clear ALL Warehouse data for ALL periods? This cannot be undone.",confirmLabel:"Clear All",danger:true})) return;
