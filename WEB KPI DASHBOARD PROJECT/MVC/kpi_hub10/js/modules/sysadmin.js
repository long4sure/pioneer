    ...
    const html = pending.length
        ? pending.map((req, i) => `
            <tr>
                ...
                <td class="nowrap">
                    <button class="sa-action-btn sa-action-approve" onclick="saApprovePending(${i})">✓ Approve</button>
                    <button class="sa-action-btn sa-action-delete"  onclick="saRejectPending(${i})"  style="margin-left:4px">✕ Reject</button>
                </td>
            </tr>`).join('')
